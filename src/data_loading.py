...
class LMDataModule(L.LightningDataModule):
    ...
    def train_dataloader(self):
        common_args = dict(
            ...
            (persistent_workers=True if self.args.num_workers > 0 else persistent_workers=False),  # https://discuss.pytorch.org/t/what-are-the-dis-advantages-of-persistent-workers/102110/10
            pin_memory=True,
