def infer_batch_size_per_device(num_devices: int, effective_batch_size: int, batch_size_per_device: int):
    ...
    resulting_batch_size_per_device = effective_batch_size / (needed_gradient_accum_steps * num_devices)
